...
def compare_histogram():
    ...
    flow_based_model_path = ".\models\my_approach_flow_based\ppo_correct_discrete_3_paths_1200000_steps.zip"
    ...
    for episode in range(1000, 1000 + num_episodes):
        ...
        naive_total_rewards.append(final_naive_reward)
        ...
        flow_based_total_rewards.append(final_flowbased_reward)

class Switch:
    def __init__(self, service_rate, queue_capacity, queue_length = 0, aggr_arrival_rate = 1):
        ...
        self.exp_queue_occupation = (self.traffic_intensity/(1 - self.traffic_intensity)) - \
                                    ...
                                    /(1 - self.traffic_intensity**(self.queue_capacity + 1))
        self.exp_delay = self.exp_queue_occupation / (self.aggr_arrival_rate * (1 - self.packet_loss_probabilty))

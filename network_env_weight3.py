...
class NetworkEnv10weight(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(low=1.0, high=3.0, shape=(self.model.no_of_edges,), dtype=np.float32)
